<div class="container justify-content-center"><br>
    ...
    if (isset($produtos)) {
        foreach ($produtos as $produto) {
            ?>
            <div class="modal fade" id="editar<?php echo $produto->id ?>" tabindex="-1" aria-labelledby="modalLabelProduto"
                 aria-hidden="true">
                <div class="modal-dialog modal-l">
                    <div class="modal-content">
                        ...
                        <div class="modal-body p-5 pt-0">
                            <form action="./router.php?c=produto&a=update&id=<?php echo $produto->id ?>" method="post">
                                <h1 class="h3 mb-3 fw-normal text-center">Produto Id #<?php echo $produto->id ?></h1>
